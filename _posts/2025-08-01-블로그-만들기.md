...
![그림1.png](/assets/img/posts/2025/08/블로그-만들기/그림1.png)
...
![그림2.png](/assets/img/posts/2025/08/블로그-만들기/그림2.png)

브라우저를 열어서 `http://127.0.0.1:4000/`를 입력한다.

아래와 같이 기본 블로그 화면이 나타나면 성공이다.

![그림3.png](/assets/img/posts/2025/08/블로그-만들기/그림3.png)

## 4. GitHub Pages 배포

Repository 페이지에서 Settings로 이동하고 소스를 GitHub Actions로 변경한다.

![그림4.png](/assets/img/posts/2025/08/블로그-만들기/그림4.png)
...
![그림5.png](/assets/img/posts/2025/08/블로그-만들기/그림5.png)
