...
![img1.png](/assets/img/2023-09-04/img1.png){: width="80%" height="80%"}
...
![img2.png](/assets/img/2023-09-04/img2.png){: width="80%" height="80%"}
...
![img3.png](/assets/img/2023-09-04/img3.png){: width="60%" height="60%"}
...
![img4.png](/assets/img/2023-09-04/img4.png){: width="80%" height="80%"}
...
![img5.png](/assets/img/2023-09-04/img5.png){: width="60%" height="60%"}
...
![img6.png](/assets/img/2023-09-04/img6.png){: width="60%" height="60%"}
...
결과적으로 전통적인 얼굴 인식 모델을 사용해 identity loss를 최소화하는 것은 대상 속성을 보존하는데 충돌이 있음을 가정한다.
...
![img7.png](/assets/img/2023-09-04/img7.png){: width="60%" height="60%"}

$\theta_{y_{i}}$는 인코더의 deep feature vector와 weight vector의 각도를 의미하며, $K, s, m$은 각각 클래스 수, scale, margin을 나타낸다. 

![img8.png](/assets/img/2023-09-04/img8.png){: width="60%" height="60%"}
...
![img10.png](/assets/img/2023-09-04/img10.png){: width="60%" height="60%"}
