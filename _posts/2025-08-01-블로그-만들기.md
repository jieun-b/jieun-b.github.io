...
![fork-repository](/assets/img/posts/2025/08/blog-setup/fork-repository.png)
...
![jekyll-serve-output](/assets/img/posts/2025/08/blog-setup/jekyll-serve-output.png)

브라우저를 열어서 `http://127.0.0.1:4000/`를 입력한다.

아래와 같이 기본 블로그 화면이 나타나면 성공이다.

![default-blog-screen](/assets/img/posts/2025/08/blog-setup/default-blog-screen.png)

## 4. GitHub Pages 배포

Repository 페이지에서 Settings로 이동하고 소스를 GitHub Actions로 변경한다.

![github-actions-setting](/assets/img/posts/2025/08/blog-setup/github-actions-setting.png)
...
![deployed-blog](/assets/img/posts/2025/08/blog-setup/deployed-blog.png)
